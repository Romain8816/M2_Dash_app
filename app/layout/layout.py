...
classification_KNeighborsClassifier = dbc.Card(
    children=[
            ...
            html.H2(html.B(html.P("KNeighbors Classifier", className="card-text"))),html.Br(),html.Hr(),html.Br(),

            html.Div([

                html.Div([

                    html.H3(html.B("Paramètrage")),html.Br(),html.Hr(),html.Br(),
                    ...
                    dbc.Checklist(id="KNeighborsClassifier_centrer_reduire",options=[{"label":"centrer réduire","value":"yes"}]),html.Br(),html.Hr(),html.Br(),
                    ...
                    dcc.Loading(id="ls-loading-1", children=[html.Div(id="ls-loading-output-1")], type="default"),html.Br(),html.Hr(),html.Br(),
                    html.H4(html.B("Paramètres du modèle :")),html.Br(),html.Br(),
                    ...
                    dcc.Loading(id="ls-loading-3", children=[html.Div(id="ls-loading-output-3")], type="default"),html.Br(),html.Hr(),html.Br(),
                    ...
                    dbc.Button("Valider K-Fold CrossValidation", color="success",id='KNeighborsClassifier_button_CrossValidation',n_clicks=0),
                    dcc.Loading(id="ls-loading-2", children=[html.Div(id="ls-loading-output-2")], type="default")

                ],className="six columns",style={"margin":10}),

                html.Div([

                    html.H3(html.B("Résultats :")),html.Br(),html.Br(),
