        ...
        children=[
                html.Div([
                    html.Div([
                            ...
                            html.Br(),
                            dbc.Button("Valider", color="danger",id='kmeans_button',n_clicks=0)
                        ], className="six columns"),
                        html.Div([
                            html.H4(html.B("Exploration des résultats")),
                            html.Hr(),html.Br(),
                            dcc.Dropdown(
                                id="kmeans_explore_object"
                            ),
                            html.Br(),
                            html.Div(id='kmeans_explore_object_display'),
                            html.Br(),
                            dcc.Graph(
                                id='kmeans_pca',style={'width': '90vh', 'height': '90vh'}
                            ),
                            html.Br(),
                            dcc.Graph(
                                id='kmeans_input_pca',style={'width': '90vh', 'height': '90vh'}
                            )
                        ], className="six columns"),
                    ],id="kmeans-container",style = {"margin":25,"display":"block"}, className="row"
                )
            ]
    ),
    className="mt-3",
...
classification_tabs = dbc.Tabs(
    ...
    children= [
        ...
        dbc.Tab(classification_KMEANS,label ="Kmeans", tab_id='kmeans',tab_style={'background-color':'#E4F2F2','border-color':'white'},label_style={'color':'black'})
    ]
)
